...
class GUI
{
	...
	enum DrawMenuIcon //The icons of the Draw menu (you should add more icons)
	{
		...
		ICON_RegPoly,	//Regular Polygon icon in menu
		ICON_Triangle,	//Triangle Icon in menu
		ICON_LINE,		//Line Icon in menu	

		//TODO: Add more icons names here

		ICON_EXIT,		//Exit icon in menu
...
public:
	...
	void DrawRegPoly( int* ptr_x,  int* ptr_y,  GfxInfo RectGfxInfo) const;  //Draw a regular polygan
	void DrawTriangle(Point P1, Point P2, Point P3, GfxInfo RectGfxInfo) const;  //Draw a rectangle
	void DrawCirc(Point P1, double, GfxInfo RectGfxInfo) const;
