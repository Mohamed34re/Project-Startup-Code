...
void GUI::DrawRegPoly( int *ptr_x,  int *ptr_y,  GfxInfo RectGfxInfo) const
{
	color DrawingClr;
	if (RectGfxInfo.isSelected)	//shape is selected
		DrawingClr = HighlightColor; //shape should be drawn highlighted
	...
	cout << endl << ptr_x << ptr_x[0];
	pWind->DrawPolygon(ptr_x, ptr_y, 5, style);
...
void GUI::DrawCirc(Point P1, double R, GfxInfo RectGfxInfo) const
{
	color DrawingClr;
	if (RectGfxInfo.isSelected)	//shape is selected
		DrawingClr = HighlightColor; //shape should be drawn highlighted
